#!/usr/bin/env node
/*
 Exporta um projeto Next.js standalone apenas do CV.
 - Copia a estrutura mínima necessária para rodar /cv isoladamente
 - Copia as APIs usadas pela tradução/token
 - Mantém utilitários, componentes, dados e estilos realmente usados pelo CV
*/
...
const APP = 'cv';
const cfg = { routeDir: 'cv', title: 'CV' };
