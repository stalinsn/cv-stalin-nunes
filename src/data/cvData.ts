export const cvData = {
  ...
  languages: [
    ...
    {
      name: "Inglês",
      level: "Avançado (Leitura, escrita e conversação técnica)",
    },
    {
      name: "Espanhol",
      level: "Intermediário (Conversação técnica e leitura)",
    },
  ],
  ...
  experience: [
    ...
    {
      company: "Tok&Stok",
      role: "Analista Desenvolvedor Web VTEX CMS/IO",
    ...
    },
    {
      ...
      role: "Desenvolvedor Web Ecommerces",
      period: "Ago 2019 – Fev 2020",
      location: "São Paulo – SP",
      bullets: [
